class Song:
    ...
    def add_to_genres(cls, genre=None):
        genre = genre if genre else cls.genres[-1] if cls.genres else None
    ...
    def add_to_artists(cls, artist=None):
        artist = artist if artist else cls.artists[-1] if cls.artists else None
